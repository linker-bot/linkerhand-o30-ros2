...
**弧度换算**（驱动本身只收发 `0~255`；下列范围供上层 / GUI 的 `is_rad` 线性换算使用，顺序同上表）：
...
{"stamp": 1788924344982714188, "hand_type": "right",
 "sensors": {"1": {"name": "thumb", "rows": 10, "cols": 7, "matrix": [[0, 0, 0, 0, 0, 0, 0], ...]},
             "2": {"name": "index", ...}}}

// /cb_right_hand_matrix_touch_mass —— 合力与统计
{"stamp": 1788924327241896340, "hand_type": "right",
 "sensors": {"1": {"name": "thumb", "unit": "g", "force": {"FnS": 0}, "cell_sum": 0, "cell_max": 0},
             "2": {"name": "index", ...}}}
```
